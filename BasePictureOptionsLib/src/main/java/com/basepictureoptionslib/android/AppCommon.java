...
public class AppCommon {
    ...
    //视频是否静音
    public static final String VIDEO_PLAY_MUTE_OR_UNMUTE = "video_play_mute_or_unmute";
    //视频地址
    public static final String VIDEO_PLAY_FOR_LOCAL_PATH = "video_play_for_local_path";
}
