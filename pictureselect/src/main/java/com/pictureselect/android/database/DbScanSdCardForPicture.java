...
public class DbScanSdCardForPicture extends DbBase{
    ...
    public static DbScanSdCardForPicture getInstance(Context context){
        if(dbScanDirForPicture == null){
            dbScanDirForPicture = new DbScanSdCardForPicture(context);
        }
    ...
    public boolean createTable(Context context){
        ...
        createTbBUffer.append(property.TB_SCAN_SD_CARD_FOR_PICTURE);
