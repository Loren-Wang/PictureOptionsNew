...
import com.pictureselect.android.BuildConfig;
 ...
 * 备注：
 */
public class PictureVideoDbUtils extends SQLiteOpenHelper {
    ...
    private static PictureVideoDbUtils dbUtils;
    ...
    public static PictureVideoDbUtils getInstance(Context context){
        if(dbUtils == null){
            dbUtils = new PictureVideoDbUtils(context);
        }
        return dbUtils;
    }
    ...
    public PictureVideoDbUtils(Context context) {
